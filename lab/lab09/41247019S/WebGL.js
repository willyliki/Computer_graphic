...
var FSHADER_QUAD_SOURCE = `
    ...
    void main(){ 
      ...
      gl_FragColor = vec4(vec3(texture2D(u_ShadowMap, gl_FragCoord.xy/vec2(800.0, 800.0)).r), 1.0);
    }
`;
...
function draw(){
  ...
  if( normalMode ){
    ...
    gl.enable(gl.DEPTH_TEST);
    //cube
    drawOneObjectOnScreen(cubeObj, cubeMdlMatrix, cubeMvpFromLight, 0.8, 0.8, 0.8);
    //mario
    drawOneObjectOnScreen(marioObj, marioMdlMatrix, marioMvpFromLight, 0.8, 0.8, 0.8);
  }
}
