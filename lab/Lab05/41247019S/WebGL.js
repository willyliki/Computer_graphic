...
function main(){
    ...
    pespProjMatrix2.setOrtho(-2, 2, -2, 2, -20, 20);

    frontViewMatrix3.setLookAt(0, 0, 10, 0, 0, -10, 0, 1, 0);
    pespProjMatrix3.setPerspective(30, 2, 1, 100);
...
function draw(x, y){
    ...
    //left corner
    drawOneViewport(gl, 0, 0, 200, 200, 0, 0, 0, pespProjMatrix, frontViewMatrix, modelMatrix1, modelMatrix2 );
    //right corner
    drawOneViewport(gl, 200, 0, 200, 200, 0.5, 0.5, 0.5, pespProjMatrix2, frontViewMatrix2, modelMatrix1, modelMatrix2 );
    //top
    drawOneViewport(gl, 0, 200, 400, 200, 0.9, 0.9, 0.9, pespProjMatrix3, frontViewMatrix3, modelMatrix1, modelMatrix2 );
}
